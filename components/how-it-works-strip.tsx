  ...
  return (
    <View style={{ backgroundColor: colors.surface, borderColor: colors.line, borderRadius: 18, borderWidth: 1, gap: 16, padding: 20, shadowColor: "#0B3A44", shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.05, shadowRadius: 14 }}>
      <View style={{ alignItems: "center", flexDirection: "row", flexWrap: "wrap", gap: 10, justifyContent: "space-between" }}>
        ...
        <PressLink href={"/nasil-calisir" as Href} accessibilityLabel={translateCopy("Nasıl çalışır?", language)} style={{ alignItems: "center", backgroundColor: colors.surfaceAlt, borderColor: colors.line, borderRadius: 999, borderWidth: 1, flexDirection: "row", gap: 5, paddingHorizontal: 13, paddingVertical: 8 }}>
      ...
      <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 8 }}>
        <PressLink href={"/explore" as Href} accessibilityLabel={translateCopy("Ürünleri Keşfet", language)} pressedOpacity={0.9} style={{ alignItems: "center", backgroundColor: colors.primary, borderRadius: 10, flexDirection: "row", gap: 6, paddingHorizontal: 16, paddingVertical: 10 }}>
        ...
        <PressLink href={"/create" as Href} accessibilityLabel={translateCopy("İlan Ver", language)} pressedOpacity={0.9} style={{ alignItems: "center", backgroundColor: colors.surfaceAlt, borderColor: colors.line, borderRadius: 10, borderWidth: 1, flexDirection: "row", gap: 6, paddingHorizontal: 16, paddingVertical: 10 }}>
        ...
        <PressLink href={"/partner" as Href} accessibilityLabel={translateCopy("Ortak Ol", language)} pressedOpacity={0.9} style={{ alignItems: "center", backgroundColor: colors.surfaceAlt, borderColor: colors.line, borderRadius: 10, borderWidth: 1, flexDirection: "row", gap: 6, paddingHorizontal: 16, paddingVertical: 10 }}>
