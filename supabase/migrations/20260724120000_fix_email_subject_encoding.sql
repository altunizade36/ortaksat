-- E-posta bildirim konularındaki mojibake (Türkçe ş/ğ/ı/ü/ö bozulması) düzeltildi.
-- Fonksiyon önceki bir migration/API çağrısında Türkçe karakterler bozularak (curl UTF-8 sorunu)
-- oluşturulmuştu → e-postalar "satÄ±ÅŸ" gibi bozuk konuyla gidiyordu. Kaynak UTF-8-güvenli düzeltildi.
