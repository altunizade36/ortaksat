-- listing_public_cards view'e commission_tiers eklenir (sona). Kademeli komisyon feed'e
-- yüklenip satış-anı hesabında kullanılabilsin. security_invoker → anon'un listings.commission_tiers
-- kolon grant'ı gerekir (20260710200000'da verildi). Aksi halde anon feed 401 (gotcha).
