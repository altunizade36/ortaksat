-- Örnek/vitrin ilanları için "demo" bayrağı. Demo ilanlar sarı "ÖRNEK" şeridiyle
-- gösterilir; mesajlaşma/ortaklık kapalıdır (yalnızca görünüm amaçlı).
alter table public.listings
  add column if not exists demo boolean not null default false;

-- Public view'e demo kolonunu ekle (yalnızca sona eklenebilir).
