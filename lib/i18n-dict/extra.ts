...
export const extraDict: Record<string, string> = {
  ...
  "ile ortaklığı sonlandırmak istiyor musun? Ortaklık kapanır ve yeni talep getiremez. Kötüye kullanım varsa Engelle'yi seç.": "— do you want to end this partnership? The partnership closes and can no longer bring leads. Choose Block for abuse.",
  "borç": "owed",
  "Sattım — satıcıya bildir": "I sold it — notify seller",
  "Satışını satıcı sisteme ekleyince komisyonun başlar. Kendi yönteminle satış yaptıysan buradan satıcıya bildir.": "Your commission starts once the seller records your sale. If you made the sale with your own method, notify the seller here.",
  ...
  "Bu ortaklık satıcı tarafından kapatıldı; artık bu ürünü ortak olarak tanıtamazsın.": "This partnership was closed by the seller; you can no longer promote this product as a partner.",
  "Bu ortaklık sona erdi; artık yeni talep getiremezsin.": "This partnership has ended; you can no longer bring new leads.",
