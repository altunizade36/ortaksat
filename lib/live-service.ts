...
// IBAN/ödeme bilgisi TOPLANMAZ. OrtakSat para tutmaz; komisyon ödemesi ortak ile satıcı
// arasında Platform dışında doğrudan yapılır. (Eski fetchMyPayoutIban/saveMyPayoutIban
// KALDIRILDI — payout_info tablosuna yeni yazım yok.)
